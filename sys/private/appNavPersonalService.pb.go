...
type AppNavPersonal struct {
	...
	AppNavId  int32   `protobuf:"varint,4,opt,name=app_nav_id,json=appNavId,proto3" json:"app_nav_id"`
	...
	Nav       *AppNav `protobuf:"bytes,8,opt,name=nav,proto3" json:"nav"`
}
...
type AppNavPersonalWhere struct {
	...
	AppNavId  int32   `protobuf:"varint,8,opt,name=app_nav_id,json=appNavId,proto3" json:"app_nav_id"`
	AppNavIds []int32 `protobuf:"varint,9,rep,packed,name=app_nav_ids,json=appNavIds,proto3" json:"app_nav_ids"`
}
...
type AppNavPersonalResponse struct {
	...
	Entity *AppNavPersonal   `protobuf:"bytes,1,opt,name=entity,proto3" json:"entity"`
	Pager  *common.Pager     `protobuf:"bytes,2,opt,name=pager,proto3" json:"pager"`
	Items  []*AppNavPersonal `protobuf:"bytes,3,rep,name=items,proto3" json:"items"`
